...
router.get("/", async function (req, res, next) {
  ...
  // if (query.maxEmployees !== undefined) query.maxEmployees = parseInt(query.maxEmployees);  if (query.minEmployees !== undefined) query.minEmployees = parseInt(query.minEmployees);
